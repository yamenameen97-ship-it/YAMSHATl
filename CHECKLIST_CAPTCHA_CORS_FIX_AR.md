...
- تحديث إعدادات `backend/.env` وربط الواجهة بخدمة الـ frontend الحالية `yamshat1-1-vg1o.onrender.com` والـ backend الصحيح `yamshatl.onrender.com`.
...
3. تأكد أن متغيرات البيئة في Render مطابقة للقيم التالية:
   - `FRONTEND_ORIGIN=https://yamshat1-1-vg1o.onrender.com`

...
- تحديث إعدادات `backend/.env` وربط الواجهة بخدمة الـ frontend الحالية `yamshat1-1-yq1o.onrender.com` والـ backend الصحيح `yamshat1-ahj8.onrender.com`.
...
3. تأكد أن متغيرات البيئة في Render مطابقة للقيم التالية:
   - `FRONTEND_ORIGIN=https://yamshat1-1-yq1o.onrender.com`

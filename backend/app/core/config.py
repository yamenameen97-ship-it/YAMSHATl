...
class Settings:
    ...
    APPLE_CLIENT_ID: str = env_str("APPLE_CLIENT_ID", "")
    APPLE_TEAM_ID: str = env_str("APPLE_TEAM_ID", "")
    APPLE_KEY_ID: str = env_str("APPLE_KEY_ID", "")
    APPLE_PRIVATE_KEY: str = env_str("APPLE_PRIVATE_KEY", "")
    ...
    AWS_REGION: str = env_str("AWS_REGION", "us-east-1")

    # Phone Verification Configuration
    PHONE_VERIFICATION_CODE_EXPIRE_MINUTES: int = int(os.getenv("PHONE_VERIFICATION_CODE_EXPIRE_MINUTES", "10"))
    ...
    def cors_origins(self) -> list[str]:
        ...
        if self.CORS_ORIGINS_RAW.strip() in {'*', ''}:
            return [
                ...
                'http://localhost:5173',
                'http://127.0.0.1:5173',
                'https://yamshatl-1-yg10.onrender.com',

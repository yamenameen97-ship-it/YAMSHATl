...
from app.api.routes import (
    ...
    live, notifications, posts, recommendations, reels, search, stories, upload, users, ws,
)
...
fastapi_app.include_router(recommendations.router, prefix=settings.API_PREFIX, tags=['recommendations'])

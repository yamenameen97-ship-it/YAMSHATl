...
CREATE TABLE IF NOT EXISTS user_backups(id SERIAL PRIMARY KEY, username TEXT UNIQUE NOT NULL, encrypted_data BYTEA NOT NULL, backup_version TEXT DEFAULT 'yamshat-backup-v1', key_hint TEXT, byte_size BIGINT DEFAULT 0, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);

import { j as jsxRuntimeExports, r as reactExports, x as logger, T as DISAPPEARING_MESSAGE_OPTIONS, B as Button, h as socketManager, R as mediaUploadService, o as useParams, u as useNavigate, f as getCurrentUsername, e as useToast, U as useChatStore, q as getChatThreads, V as getMessages, W as markMessagesSeen, X as getPresence, Y as getBlockStatus, Z as Navigate, $ as sendMessageApi, a0 as deleteMessageApi, m as unblockUserApi, n as blockUserApi } from "../index-BAMQT-m6.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `yam-bubble-wrap ${isMe ? "me" : "them"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `yam-bubble ${isMe ? "bubble-me" : "bubble-them"}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bubble-actions", children: [
        ...
        isMe && !message.deleted ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => onDelete(message.id), children: "🗑" }) : null
      ] })
    ] })
  ] });
}
function Chat() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MainLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "yam-chat-screen", dir: "rtl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-chat-stage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "yam-chat-stage-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "yam-stage-icon", onClick: () => navigate("/inbox"), title: "العودة لقائمة المحادثات", children: "→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-chat-stage-peer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { name: peer, src: peerThread.avatar, size: 52, ring: true }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-chat-stage-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "yam-stage-icon", onClick: () => setCallMode("voice"), title: "مكالمة صوتية", children: "📞" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "yam-stage-icon", onClick: () => setCallMode("video"), title: "مكالمة فيديو", children: "📹" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: `yam-stage-icon ${showDetailsDrawer ? "active" : ""}`, onClick: () => setShowDetailsDrawer((prev) => !prev), title: "إظهار التفاصيل", children: showDetailsDrawer ? "⟨" : "⟩" })
        ] })
      ] }),

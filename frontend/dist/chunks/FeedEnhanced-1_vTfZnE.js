import { bA as hasPreviousPage, bB as hasNextPage, E as reactExports, F as useNavigate, I as jsxRuntimeExports, ai as useQueryClient, _ as useToast, ah as resolveMediaUrl, aF as getAuthToken, $ as useAppStore, aD as followUser, bC as unmuteUser, bD as muteUser, a9 as unblockUserApi, aa as blockUserApi, a4 as __vitePreload, a0 as MainLayout, aP as getStoredUserSnapshot, af as getCurrentUsername, by as NavLink, aG as getCsrfToken, bE as BACKEND_ORIGIN, O as clearStoredUser, aI as redirectToAppPath } from "../index-DRmq1dbV.js";
import { u as useIsMobile } from "./useIsMobile-CDUmCrZA.js";
import { g as getComments, b as addComment, s as sortPostsNewestFirst, d as getPosts, l as likePost, e as savePost, f as sharePost, h as deletePost, u as updatePost } from "./posts-CVbaeloP.js";
import { M as Modal } from "./Modal-Xyu_csOj.js";
import { R as ReportModal } from "./ReportModal-Dhh4Cm9K.js";
import { Q as QueryObserver, u as useBaseQuery } from "./useBaseQuery-Bp9m-ptR.js";
import { P as PostComposer } from "./PostComposer-A5eOLdUT.js";
import { b as formatCompactNumber } from "./YamshatDesign-COVLXNSC.js";
import "./react-virtualized-auto-sizer.esm-CA6mbh5m.js";
...
function MobilePostCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "ym-post-card", dir: "rtl", children: [
    ...
    banner && (banner.type === "image" || banner.type === "video" || banner.type === "logo") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-post-banner-new", children: [
            ...
            onError: (e) => {
              try {
                ...
                if (parent && !parent.querySelector(".banner-image-fallback")) {
                  ...
                  fb.innerHTML = '<svg viewBox="0 0 24 24" width="36" height="36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="9" cy="9" r="1.6"/><path d="M21 15l-5-5-9 9"/></svg><span>تعذّر تحميل الصورة</span>';
      ...
      banner.type === "video" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "banner-video-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "video",
        {
          src: banner.url,
          poster: banner.poster || void 0,
          controls: true,
          playsInline: true,
          preload: "metadata",
          ...
          onError: (e) => {
            try {
              ...
              if (parent && !parent.querySelector(".banner-image-fallback")) {
                ...
                fb.innerHTML = '<svg viewBox="0 0 24 24" width="36" height="36" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polygon points="5 3 19 12 5 21 5 3"/></svg><span>تعذّر تشغيل الفيديو</span>';
                parent.appendChild(fb);
              }
            } catch {
            }
      ...
      banner.type === "logo" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "banner-logo-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "ym-logo-large", viewBox: "0 0 200 200", "aria-hidden": "true", preserveAspectRatio: "xMidYMid meet", children: [
...
function buildBanner(post = {}) {
  const rawMediaCandidates = Array.isArray(post.media_urls) && post.media_urls.length ? post.media_urls : [post.media_url || post.media || post.image_url || post.thumbnail_url].filter(Boolean);
  const firstMedia = rawMediaCandidates[0] || "";
  const isVideo = Boolean(post.has_video) || String(post.media_type || "").toLowerCase() === "video" || Boolean(post.is_reel) || isVideoMediaUrl$1(firstMedia, post);
  if (isVideo) {
...
function FeedMobile() {
  ...
  const [reportPostTarget, setReportPostTarget] = reactExports.useState(null);

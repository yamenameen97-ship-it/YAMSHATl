...
import { g as getActiveLiveStreams } from "./liveStreamApi-DOCsImD-.js";
...
function MobilePostCard({
  ...
  const {
    ...
    text = "",
    banner = null,
    // { type: 'image'|'logo', url?, title?, slogan? }
    liked = false,
    saved = false
  } = post;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "ym-post", "aria-label": `منشور من ${authorName}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-post-actions", role: "group", "aria-label": "إجراءات المنشور", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: `ym-action like ${liked ? "is-active" : ""}`, onClick: handleClick(onLike), "aria-label": "إعجاب", "aria-pressed": liked, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "أعجبني" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "ym-action", onClick: handleClick(onComment), "aria-label": "تعليق", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "تعليق" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "ym-action", onClick: handleClick(onShare), "aria-label": "مشاركة", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "label", children: "مشاركة" })
      ] }),
...
function normalizePost(p, i) {
  ...
  return {
    ...
    timeText: timeAgoAr$1(p.created_at || p.published_at),
    verified,
...
function FeedMobile() {
  ...
  const posts = reactExports.useMemo(() => {
    const list = Array.isArray(rawPosts) && rawPosts.length ? rawPosts.map((p, i) => normalizePost(p, i)) : [WELCOME_POST];
    return list.map((p) => {
...
function PostCard({ post }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "yam-post-card-v2", children: [
    ...
    post.isLive ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          mediaItems[0]?.url ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: mediaItems[0].url, alt: "Cover", style: { width: "100%", aspectRatio: "16/9", objectFit: "cover" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "100%", aspectRatio: "16/9", background: "#1a1a1a", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "48px" }, children: "📺" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { position: "absolute", top: "12px", left: "12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "live-badge", style: {
            background: "#0047ff",
            color: "white",
            padding: "4px 12px",
            borderRadius: "20px",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { width: "8px", height: "8px", background: "white", borderRadius: "50%", display: "inline-block" } }),
            "مباشر"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { style: { margin: 0, fontSize: "16px" }, children: [
              post.authorName,
              " بدأ البث"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: "4px 0 0", fontSize: "13px", opacity: 0.8 }, children: [
              "👁 ",
              post.viewers || 0,
              " مشاهد"
            ] })
      ...
      post.liveUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function FeedDesktopInner() {
  ...
  reactExports.useEffect(() => {
    ...
    const interval = setInterval(fetchActiveLiveStreams, 3e4);

import { b0 as reactExports, ar as jsxRuntimeExports, bz as useNavigate, by as useLocation, bB as useParams, bG as useToast, a7 as getCurrentUsername, v as bootstrapCallService, Q as ensureNotificationPermission, bl as socketManager, h as MainLayout, C as CallExperience, bk as showLocalNotification } from "../index-CbZjTFV4.js";
import { B as listPinnedMessages, D as pinGroupMessage, p as getGroupDetails, r as getGroupMessages, i as deleteGroupMessage, F as reactToGroupMessage, l as forwardGroupMessage, P as uploadGroupMedia, I as sendGroupMessage } from "./groups-iGSDUnA6.js";
import { a as MessageActionsToolbar, b as MessageReactionPicker, M as MediaPreviewModal } from "./MessageReactionPicker-BifMj7Fc.js";
import { V as VoiceMessagePlayer } from "./VoiceMessagePlayer-BBXjz83a.js";
/* empty css                         */
import { R as ReportModal } from "./ReportModal-CYzEgR-Q.js";
...
const GroupChat = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MainLayout, { hideNav: true, lockScroll: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-group-chat-container", dir: "rtl", "data-yam-group-root": "true", style: { fontFamily: "'Noto Sans Arabic','Cairo','Tahoma',sans-serif" }, children: [

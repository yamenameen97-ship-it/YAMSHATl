import { a_ as reactExports, aq as jsxRuntimeExports, bv as useNavigate, bu as useLocation, bx as useParams, bC as useToast, a7 as getCurrentUsername, v as bootstrapCallService, Q as ensureNotificationPermission, bj as socketManager, h as MainLayout, C as CallExperience, bi as showLocalNotification } from "../index-2I4hYPnI.js";
import { B as listPinnedMessages, D as pinGroupMessage, p as getGroupDetails, r as getGroupMessages, i as deleteGroupMessage, F as reactToGroupMessage, l as forwardGroupMessage, P as uploadGroupMedia, I as sendGroupMessage } from "./groups-DqmtpX-5.js";
import { a as MessageActionsToolbar, b as MessageReactionPicker, M as MediaPreviewModal } from "./MessageReactionPicker-C88TimST.js";
import { V as VoiceMessagePlayer } from "./VoiceMessagePlayer-DD0mL2o0.js";
/* empty css                         */
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MainLayout, { hideNav: true, lockScroll: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-group-chat-container", dir: "rtl", "data-yam-group-root": "true", style: { fontFamily: "'Noto Sans Arabic','Cairo','Tahoma',sans-serif", position: "relative", isolation: "isolate" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "yam-group-input-area", style: { position: "sticky", bottom: 0, insetInline: 0, display: "grid", gridTemplateColumns: "42px minmax(0, 1fr) 42px", alignItems: "center", gap: "10px", padding: "10px 12px calc(10px + env(safe-area-inset-bottom, 0px) + var(--yam-keyboard-offset, 0px))", background: "linear-gradient(180deg, rgba(9, 13, 24, 0.92), rgba(9, 13, 24, 0.98))", borderTop: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 -16px 34px rgba(0,0,0,0.34)", zIndex: 120 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "yam-input-wrapper", style: { minWidth: 0, width: "100%", display: "grid", gridTemplateColumns: "minmax(0, 1fr) auto", alignItems: "center", gap: "8px", direction: "rtl", borderRadius: "24px", padding: "0 12px", minHeight: "46px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.09)", overflow: "hidden", order: 2 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "yam-input-icon", style: { width: "28px", height: "28px", display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "#94a3b8", fontSize: "18px" }, children: "😊" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {

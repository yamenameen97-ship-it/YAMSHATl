const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/posts-CuljhCYS.js","index-D_Nx8mZz.js"])))=>i.map(i=>d[i]);
import { b0 as reactExports, bB as useQueryClient, bE as useToast, as as jsxRuntimeExports, d as Card, c as Button, aF as mediaUploadService, _ as __vitePreload } from "../index-D_Nx8mZz.js";
import { b as createPost, i as injectPostIntoFeedCache, c as clearLocalFeedCaches } from "./posts-CuljhCYS.js";
      ...
      if (isVideoMedia && media) {
        try {
          const { uploadPostMedia } = await __vitePreload(async () => {
            const { uploadPostMedia: uploadPostMedia2 } = await import("./posts-CuljhCYS.js").then((n) => n.p);

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/posts-8HKtDszf.js","index-2I4hYPnI.js"])))=>i.map(i=>d[i]);
import { a_ as reactExports, bz as useQueryClient, bC as useToast, aq as jsxRuntimeExports, d as Card, c as Button, aD as mediaUploadService, _ as __vitePreload } from "../index-2I4hYPnI.js";
import { b as createPost, i as injectPostIntoFeedCache, c as clearLocalFeedCaches } from "./posts-8HKtDszf.js";
      ...
      if (isVideoMedia && media) {
        try {
          const { uploadPostMedia } = await __vitePreload(async () => {
            const { uploadPostMedia: uploadPostMedia2 } = await import("./posts-8HKtDszf.js").then((n) => n.p);

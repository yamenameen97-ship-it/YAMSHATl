const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/posts-BEeH67OQ.js","index-CbZjTFV4.js"])))=>i.map(i=>d[i]);
import { b0 as reactExports, bD as useQueryClient, bG as useToast, ar as jsxRuntimeExports, d as Card, c as Button, aE as mediaUploadService, _ as __vitePreload } from "../index-CbZjTFV4.js";
import { b as createPost, i as injectPostIntoFeedCache, c as clearLocalFeedCaches } from "./posts-BEeH67OQ.js";
      ...
      if (isVideoMedia && media) {
        try {
          const { uploadPostMedia } = await __vitePreload(async () => {
            const { uploadPostMedia: uploadPostMedia2 } = await import("./posts-BEeH67OQ.js").then((n) => n.p);

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/posts-C7Lsj7RA.js","index-TztUfWYS.js"])))=>i.map(i=>d[i]);
import { b0 as reactExports, bD as useQueryClient, bG as useToast, ar as jsxRuntimeExports, d as Card, c as Button, aE as mediaUploadService, _ as __vitePreload } from "../index-TztUfWYS.js";
import { b as createPost, i as injectPostIntoFeedCache, c as clearLocalFeedCaches } from "./posts-C7Lsj7RA.js";
      ...
      if (isVideoMedia && media) {
        try {
          const { uploadPostMedia } = await __vitePreload(async () => {
            const { uploadPostMedia: uploadPostMedia2 } = await import("./posts-C7Lsj7RA.js").then((n) => n.p);

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/posts-BMr4cr0i.js","index-D5NOBPt4.js"])))=>i.map(i=>d[i]);
import { b0 as reactExports, bD as useQueryClient, bG as useToast, ar as jsxRuntimeExports, d as Card, c as Button, aE as mediaUploadService, _ as __vitePreload } from "../index-D5NOBPt4.js";
import { b as createPost, i as injectPostIntoFeedCache, c as clearLocalFeedCaches } from "./posts-BMr4cr0i.js";
      ...
      if (isVideoMedia && media) {
        try {
          const { uploadPostMedia } = await __vitePreload(async () => {
            const { uploadPostMedia: uploadPostMedia2 } = await import("./posts-BMr4cr0i.js").then((n) => n.p);

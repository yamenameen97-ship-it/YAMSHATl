import { F as useNavigate, a8 as useParams, $ as useAppStore, af as getCurrentUsername, E as reactExports, ah as resolveMediaUrl, I as jsxRuntimeExports, a0 as MainLayout, au as getMe, av as getProfileBundle, aw as getRelationship, ax as getUserPosts } from "../index-DRmq1dbV.js";
...
function extractProfile(payload = {}, currentUsername = "") {
  ...
  const stats = {
    ...
    likes: Number(
      user.likes_count ?? user.likes_received ?? payload.likes_count ?? payload.total_likes ?? 0
    ),
  ...
  const bioLines = bioRaw ? bioRaw.split(/\n+/).map((line) => line.trim()).filter(Boolean).slice(0, 4) : [];
...
function normalizeProfilePosts(payload) {
  const source = Array.isArray(payload) ? payload : payload?.posts || payload?.items || payload?.results || payload?.data || [];
  ...
  return source.map((post, index) => {
    ...
    const image = post?.image_url || post?.image || post?.media_url || post?.media?.url || post?.thumbnail_url || "";
...
function ProfilePostsList({ username, avatar, displayName, verified }) {
  const [items, setItems] = reactExports.useState(POSTS);
  const [loadingPosts, setLoadingPosts] = reactExports.useState(true);
  const [postsError, setPostsError] = reactExports.useState("");
  ...
  if (loadingPosts && items.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-empty-state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "جارٍ تحميل المنشورات…" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    items.map((post) => {
      const imageSrc = post.image ? resolveMediaUrl(post.image) : "";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "ym-ref-post-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-post-head", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-post-author", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatar, alt: username }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: displayName || username || "مستخدم" }),
                verified ? /* @__PURE__ */ jsxRuntimeExports.jsx(VerifiedBadge, { size: 15 }) : null
              ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "ym-ref-post-menu", "aria-label": "خيارات المنشور", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "menu", size: 18, color: "rgba(230,233,255,0.8)" }) })
        ] }),
        post.content?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-post-copy", children: post.content.map((line, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: line }, `${post.id}-line-${index}`)) }) : null,
        imageSrc ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-post-image-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imageSrc, alt: "صورة المنشور", className: "ym-ref-post-image", loading: "lazy" }) }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsx(PostFooter, { stats: post.stats })
      ] }, post.id);
    }),
    !loadingPosts && postsError ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "rgba(255, 155, 155, 0.92)", fontSize: 12.5, marginTop: 10 }, children: "تعذر تحميل بعض المنشورات الحقيقية، فتم عرض نسخة احتياطية مؤقتة." }) : null
  ] });
}
...
function Profile() {
  ...
  const isOwnProfile = reactExports.useMemo(() => {
    ...
    const targetUsername2 = String(routeUsername || "").trim().replace(/^@/, "").toLowerCase();
    const myUsername = currentUsername.toLowerCase();
    if (targetUsername2 && myUsername && targetUsername2 === myUsername) return true;
    if (targetUsername2 && !myUsername) return false;
    if (!targetUsername2) return true;
    return false;
  }, [routeUsername, currentUsername, session]);
  const [activeTab, setActiveTab] = reactExports.useState("posts");
  const [profile, setProfile] = reactExports.useState(() => extractProfile({}, currentUsername));
  const [relationship, setRelationship] = reactExports.useState({ following: false, loading: false });
  ...
  const statsDisplay = reactExports.useMemo(() => [
  ...
  const avatarSrc = reactExports.useMemo(() => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-profile-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-topbar", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-topbar-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: profile.username || "مستخدم" }),
          profile.verified ? /* @__PURE__ */ jsxRuntimeExports.jsx(VerifiedBadge, { size: 16 }) : null
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-profile-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-avatar-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-avatar-ring", children: avatarSrc ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatarSrc, alt: profile.username, className: "ym-ref-avatar" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-avatar ym-ref-avatar-fallback", "aria-hidden": "true", children: (profile.displayName || profile.username || "U").slice(0, 2).toUpperCase() }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-stats", children: statsDisplay.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-stat", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: loading ? "—" : item.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.label }),
          index < statsDisplay.length - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "ym-ref-stat-divider", "aria-hidden": "true" }) : null
        ] }, item.label)) }),
        !isOwnProfile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-actions", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "ym-ref-action ym-ref-action-primary", children: relationship.following ? "إلغاء المتابعة" : "متابعة" })
        ] }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-bio", children: [
          ...
          error ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#ff8b8b", fontSize: 13, marginTop: 6 }, children: error }) : null
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ym-ref-content", children: activeTab === "posts" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProfilePostsList,
        {
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ym-ref-empty-state", children: [

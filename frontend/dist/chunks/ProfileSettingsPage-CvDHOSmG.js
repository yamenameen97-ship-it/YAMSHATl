import { F as useNavigate, E as reactExports, I as jsxRuntimeExports, J as Button } from "../index-DRmq1dbV.js";
    ...
    SettingsShell,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SettingsSection, { title: "الحسابات المحظورة والمكتومة", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsRow, { icon: "🚫", title: "الحسابات المحظورة", description: "عرض وإدارة الحسابات التي حظرتها", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", size: "small", onClick: () => navigate("/settings?tab=blocked"), children: "إدارة" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsRow, { icon: "🔇", title: "الحسابات المكتومة", description: "حسابات لا ترى محتواها", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", size: "small", onClick: () => navigate("/settings?tab=muted"), children: "إدارة" }) })
        ] })
      ]
    }
  );

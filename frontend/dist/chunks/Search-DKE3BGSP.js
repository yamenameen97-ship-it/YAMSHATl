import { aK as reactExports, A as API, a$ as useLocation, b0 as useNavigate, a1 as getLiveRooms, ah as jsxRuntimeExports, k as MainLayout, d as Card, c as Button, g as ListSkeleton, ab as getStoredUserSnapshot, Z as getCurrentUsername } from "../index-BtxTC4_g.js";
import { I as Input } from "./Input-BWKfBdZJ.js";
import { a as ErrorState, E as EmptyState } from "./ErrorState-Dh-1l-n-.js";
import { e as getPosts } from "./posts-BsDvbV4a.js";
import { b as getUsers } from "./users-DNLqh2s5.js";
import { b as buildTrendingHashtags, n as normalizeSearchText, t as tokenize, r as rankSuggestedUsers, a as fuzzyScore, e as extractHashtags, g as groupSearchResults } from "./recommendationService-CD7rSnI7.js";
import { A as AutoSizer, F as FixedSizeList } from "./react-virtualized-auto-sizer.esm-D9dlqhMm.js";
...
function buildEntry(type, item = {}) {
  ...
  const route = type === "users" ? `/profile/${encodeURIComponent(username || item.id || "")}` : type === "hashtags" ? `/search?q=${encodeURIComponent(String(title).replace(/^#/, ""))}` : type === "reels" ? "/reels" : type === "live" ? "/live" : "/";
  const searchText = [
    title,
    username,
    description,

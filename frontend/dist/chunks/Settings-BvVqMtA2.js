import { E as reactExports, b9 as audioService, I as jsxRuntimeExports, ba as SOUND_CATALOG, bb as useLanguage, bc as SUPPORTED_LANGUAGES, bd as getLanguageMeta, $ as useAppStore, a5 as API, F as useNavigate, G as useLocation, be as notificationService, bf as getCDNConfig, bg as getMediaDeliveryProfile, bh as logoutUser, O as clearStoredUser, a0 as MainLayout, a2 as Card, bi as applyFontSize, bj as FontSizeSettings, bk as MEDIA_SECURITY, bl as SIGNED_URL_TTL_SECONDS, bm as currentMediaProviderLabel, bn as YamServicesMenu } from "../index-DRmq1dbV.js";
import { g as getTranslationPrefs, s as saveTranslationPrefs, c as clearTranslationCache } from "./translationService-tb0zyizg.js";
import { b as SettingsRow, c as SettingsToggle } from "./SettingsShell-C-ZBPdrd.js";
function useAudio() {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `settings-layout ${isMobile ? mobileView === "section" ? "mobile-showing-section" : "mobile-showing-menu" : ""}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "settings-main", children: [
          ...
          activeTab === "about" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "s-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsRow, { icon: "📦", title: "الإصدار", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muted s-p", style: { fontSize: 11.5 }, children: `v${"87.21.0"}` }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsRow, { icon: "🏗️", title: "رقم البناء", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muted", style: { fontSize: 11.5 }, children: "2026.07.15" }) }),

import { b0 as reactExports, s as audioService, as as jsxRuntimeExports, m as SOUND_CATALOG, bv as useLanguage, n as SUPPORTED_LANGUAGES, aa as getLanguageMeta, br as useAppStore, A as API, bx as useNavigate, bw as useLocation, aQ as notificationService, a1 as getCDNConfig, ac as getMediaDeliveryProfile, aC as logoutUser, z as clearStoredUser, h as MainLayout, d as Card, r as applyFontSize, F as FontSizeSettings, M as MEDIA_SECURITY, S as SIGNED_URL_TTL_SECONDS, H as currentMediaProviderLabel, Y as YamServicesMenu } from "../index-D_Nx8mZz.js";
import { g as getTranslationPrefs, s as saveTranslationPrefs, c as clearTranslationCache } from "./translationService-tb0zyizg.js";
import { S as SettingsRow, c as SettingsToggle } from "./SettingsShell-BgR7wfkG.js";
function useAudio() {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `settings-layout ${isMobile ? mobileView === "section" ? "mobile-showing-section" : "mobile-showing-menu" : ""}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "settings-main", children: [
          ...
          activeTab === "about" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "s-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsRow, { icon: "📦", title: "الإصدار", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muted s-p", style: { fontSize: 11.5 }, children: `v${"87.19.0"}` }) }),

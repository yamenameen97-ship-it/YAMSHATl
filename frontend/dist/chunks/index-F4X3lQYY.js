import { b8 as useToast, b1 as useNotificationStore, aK as reactExports, aT as socketManager, ay as normalizeNotification, ah as jsxRuntimeExports, k as MainLayout, d as Card, c as Button, a5 as getNotifications, q as audioService, aq as maybeShowBrowserNotification, aL as redirectToAppPath } from "../index-BtxTC4_g.js";
...
function Notifications() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(MainLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 920, margin: "0 auto", padding: "20px 10px", height: "calc(100vh - 70px)", display: "flex", flexDirection: "column", gap: 18 }, children: [

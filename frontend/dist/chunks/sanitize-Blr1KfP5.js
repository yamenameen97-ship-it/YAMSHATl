import { ar as jsxRuntimeExports, c as Button } from "../index-TztUfWYS.js";
import { I as Input } from "./Input-BfV15kGG.js";
function CaptchaBox({
  challenge,
  captcha,
  value,
  ...
  const refreshLabel = refreshCooldown > 0 ? `تحديث (${refreshCooldown}ث)` : loading ? "جارٍ التحميل…" : hasChallenge ? "تحديث" : "إعادة المحاولة";
  const questionText = hasChallenge ? currentChallenge.question : loading ? "جارٍ تحميل الكابتشا..." : 'تعذر تحميل الكابتشا — اضغط "إعادة المحاولة"';
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-box", dir: "rtl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "field-label", children: "كابتشا الأمان" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "captcha-question",
            style: !hasChallenge ? { opacity: 0.7, fontSize: "0.9em" } : void 0,
    ...
    error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "field-hint error-text", children: error }) : null,
    !hasChallenge && !loading && !error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "field-hint", style: { color: "#b45309", marginTop: 6 }, children: "⚠️ الخادم قد يكون في وضع السكون. الاستيقاظ يستغرق ~30 ثانية في أول طلب." }) : null
  ] });
}
...
const sanitizeInputText = (value, options = {}) => {
  const { maxLength = 255, trim = true, collapseWhitespace = true } = options;
  let normalized = String(value ?? "");
  normalized = normalized.replace(/[ -]/g, " ");
  normalized = purify.sanitize(normalized, { ALLOWED_TAGS: [], ALLOWED_ATTR: [] });

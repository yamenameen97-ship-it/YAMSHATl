import { ah as jsxRuntimeExports, c as Button } from "../index-BtxTC4_g.js";
import { I as Input } from "./Input-BWKfBdZJ.js";
function CaptchaBox({ challenge, captcha, value, onChange, onRefresh, loading = false, disabled = false, error = "", refreshCooldown = 0 }) {
  const currentChallenge = challenge || captcha || null;
  const refreshLabel = refreshCooldown > 0 ? `تحديث (${refreshCooldown}ث)` : "تحديث";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "captcha-question", children: currentChallenge?.question || "..." })
      ] }),

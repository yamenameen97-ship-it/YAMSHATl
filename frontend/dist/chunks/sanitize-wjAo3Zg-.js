...
function CaptchaBox({ challenge, captcha, value, onChange, onRefresh, loading = false, disabled = false, error = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-box", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "captcha-row", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "secondary", onClick: onRefresh, loading, disabled: disabled || loading, className: "captcha-refresh-btn", children: "تحديث" })
    ] }),

import { a as __toESM, r as __exportAll } from "./rolldown-runtime-DuU1KJyR.js";
import { F as notifyManager, I as environmentManager, L as noop$1, M as MutationObserver, N as InfiniteQueryObserver, P as QueryObserver, R as shouldThrowError, it as require_react } from "./vendor-9lSzsY2K.js";
...
function useBaseQuery(options, Observer, queryClient) {
	...
	if (defaultedOptions.experimental_prefetchInRender && !environmentManager.isServer() && willFetch(result, isRestoring)) (isNewCacheEntry ? fetchOptimistic(defaultedOptions, observer, errorResetBoundary) : query?.promise)?.catch(noop$1).finally(() => {
		observer.updateResult();
	});
...
axios.default = axios;
//#endregion
export { QueryClientProvider as a, useQuery as i, useInfiniteQuery as n, useQueryClient as o, useMutation as r, axios as t };

...
/**
 * ربط البث بمنشور في الفيد
 */
export const linkLiveStreamToPost = (streamId, postData = {}) =>
  apiClient.post('/', {
    type: 'LIVE',
    live_stream_id: streamId,
    content: postData.title || 'بث مباشر جديد',
    thumbnail: postData.thumbnail || '',
    viewers: postData.viewers || 0,
    is_live: true,
    username: postData.username
  });

/**
 * تحديث حالة منشور البث (عند الانتهاء)
 */
export const updateStreamPostStatus = (streamId, isLive, duration = '') =>
  apiClient.post('/update_stream_status', {
    live_stream_id: streamId,
    is_live: isLive,
    duration: duration
  });

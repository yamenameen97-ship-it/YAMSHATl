...
export const AdminReportsEnhanced = ({ reports = [] }) => {
  ...
  const approveReport = useCallback(async () => {
    ...
    try {
      await API.post(`/admin/reports/${selectedReport.id}/approve`, {
  ...
  const rejectReport = useCallback(async () => {
    ...
    try {
      await API.post(`/admin/reports/${selectedReport.id}/reject`, {
        notes: moderationNotes,
  ...
  const banReportedUser = useCallback(async () => {
    ...
    try {
      await API.post(`/admin/reports/${selectedReport.id}/ban-user`, {
  ...
  const warnReportedUser = useCallback(async () => {
    ...
    try {
      await API.post(`/admin/reports/${selectedReport.id}/warn-user`, {
        userId: selectedReport.reportedUserId,
        reason: selectedReport.reason,
        notes: moderationNotes
      });

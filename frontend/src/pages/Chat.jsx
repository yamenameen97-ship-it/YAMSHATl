        ...
        <Card className="chat-panel">
          <div className="chat-header">
            ...
            <div className="chat-header-actions">
              <Button variant="secondary" onClick={() => navigate(`/profile/${encodeURIComponent(otherUser)}`)}>الملف الشخصي</Button>
          ...
          <div className="composer">
            ...
            <Input value={text} onChange={(event) => handleTypingChange(event.target.value)} onKeyDown={handleComposerKeyDown} placeholder="اكتب رسالة... واضغط Enter للإرسال" />

    ...
    <MainLayout>
      <section className="feed-layout">
        <div className="feed-main">
          <Card className="home-story-strip-card">
            <div className="section-head compact home-strip-head">
              <div>
                ...
                <p className="muted no-margin">الشريط العلوي للستوري منفصل عن المنشورات مثل المرجع.</p>
              </div>
          ...
          <Card className="composer-card upload-dropzone home-composer-card"
            ...
            <div className="section-head compact">
              <div>
                <h3 className="section-title">المنشورات</h3>
                <p className="muted">الهوم للمنشورات فقط، وباقي الأقسام انتقلت لصفحات مستقلة.</p>
              </div>
            </div>

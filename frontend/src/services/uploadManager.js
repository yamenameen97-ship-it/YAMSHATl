...
export class UploadManager {
  constructor(options = {}) {
    this.cloudinaryUrl = options.cloudinaryUrl || viteEnv.VITE_CLOUDINARY_URL || legacyEnv.REACT_APP_CLOUDINARY_URL || '';
    this.cloudinaryPreset = options.cloudinaryPreset || viteEnv.VITE_CLOUDINARY_PRESET || legacyEnv.REACT_APP_CLOUDINARY_PRESET || '';
    this.apiUrl = options.apiUrl || API_BASE || viteEnv.VITE_API_BASE || viteEnv.VITE_API_URL || legacyEnv.REACT_APP_API_URL || '';
...
export const defaultUploadManager = new UploadManager({
  cloudinaryUrl: viteEnv.VITE_CLOUDINARY_URL || legacyEnv.REACT_APP_CLOUDINARY_URL || '',
  cloudinaryPreset: viteEnv.VITE_CLOUDINARY_PRESET || legacyEnv.REACT_APP_CLOUDINARY_PRESET || '',
  apiUrl: API_BASE || viteEnv.VITE_API_BASE || viteEnv.VITE_API_URL || legacyEnv.REACT_APP_API_URL || '',
});

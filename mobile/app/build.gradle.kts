...
val appBaseUrl = (project.findProperty("APP_BASE_URL") as String?) ?: "https://yamshat-1ya4.onrender.com/api/"
val socketUrl = (project.findProperty("APP_SOCKET_URL") as String?) ?: "https://yamshat-1ya4.onrender.com"
val agoraAppId = (project.findProperty("AGORA_APP_ID") as String?) ?: ""
val webAppUrl = (project.findProperty("WEB_APP_URL") as String?) ?: "https://yamshat8.onrender.com/"

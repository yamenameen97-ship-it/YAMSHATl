...
interface ApiService {
    ...
    @GET("posts")
    fun getPosts(@Query("page") page: Int = 1, @Query("limit") limit: Int = 10): Call<List<Post>>
    ...
    @GET("reels")
    fun getReels(@Query("page") page: Int = 1, @Query("limit") limit: Int = 10): Call<List<Reel>>
    ...
    @GET("discover/recommendations/reels")
    fun getRecommendedReels(@Query("limit") limit: Int = 15): Call<List<Reel>>

    @GET("search/smart")
    fun smartSearch(@Query("q") query: String, @Query("limit") limit: Int = 20): Call<List<SearchResultItem>>

    @POST("moderation/analyze")
    fun analyzeContent(@Body body: Map<String, @JvmSuppressWildcards Any?>): Call<ModerationDecision>

    @POST("translate")
    fun translate(@Body body: Map<String, String>): Call<TranslationResult>

    @GET("billing/subscriptions/plans")
    fun getSubscriptionPlans(): Call<List<SubscriptionPlan>>
    ...
    @POST("create_live")
    fun createLive(@Body body: Map<String, @JvmSuppressWildcards Any>): Call<ApiMessage>
